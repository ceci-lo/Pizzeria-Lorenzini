...
<template>
   <div class="divPizzeria">
    <img src="/img/pizza.jpg" alt="pizzeria lorenzini imagen principal" class="imgPizzeria" />
  </div>
    ...
    <div class="row g-0">
      ...
      <div class="col-md-8">
        <div class="card-body">
          ...
          <div>
            ...
            <div  class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              <div class="modal-dialog" >
                <div class="modal-content" v-for="pi in pizza" >
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">{{ pi.Nombre }}</h1>
          ...
          <p class="card-text"><small class="text-muted">Envio en 30-40 min</small></p>
        </div>
      </div>
    </div>
  </div>
